...
//========================================================================================
	...
	Flux<User> fluxWithDoOnPrintln() {
		return repository.findAll().doOnSubscribe(sus-> System.out.print("Starting:"))
				.doOnNext(character -> System.out.println(character.getFirstname() + " " + character.getLastname()))
